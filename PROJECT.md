...
status: active
created: "2026-09-12"
repo: "https://github.com/human-design-group/nah-agent-workbench"
kanban: "https://github.com/orgs/human-design-group/projects/1"
metadata:
  scope: "org:human-design-group"
  ecosystem: notahuman
  target_platforms: ["Cursor", "VS Code", "AgentOS"]
  runtime:
    antigravity: true
    claude: true
    hermes: true
...
- **OmniRoute & Permissions Control**: In-card model selection, auto-approve policies, and voice transcription controls.

## Official Links
- **GitHub Repository**: [https://github.com/human-design-group/nah-agent-workbench](https://github.com/human-design-group/nah-agent-workbench)
- **Product Kanban Board**: [https://github.com/orgs/human-design-group/projects/1](https://github.com/orgs/human-design-group/projects/1)
- **Agent Ground-Truth**: [AGENTS.md](AGENTS.md)
