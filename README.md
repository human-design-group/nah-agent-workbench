...
**Agent Workbench** is an official **Human Design Group** product delivering a responsive multi-agent mission control dashboard for Cursor, VS Code, and notahuman AgentOS.

---

## Key Features

- **Dynamic Multi-Agent Grid**: Responsive 2x2 grid and 1x4 vertical columns with butter-smooth draggable resize gutters.
...
```bash
cd "06 Engineering/nah-agent-workbench"
npm run install-ext
```
